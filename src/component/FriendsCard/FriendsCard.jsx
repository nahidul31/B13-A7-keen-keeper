        ...
        <div className="card-body items-center text-center">
          ...
          <div className="flex gap-2 mt-2">
            {tags.map((tag, idx) => (
              <div
                key={idx}
                className="badge badge-success p-3 text-white capitalize"
              >
                {tag}
              </div>
            ))}
          ...
          <div className="mt-3">
            <div
              className={`badge ${status === "almost due" ? "badge-warning" : status === "on-track" ? "bg-[#1a3d30]" : "badge-error"} p-3 text-white`}
            >
              {status}
            </div>
          </div>
